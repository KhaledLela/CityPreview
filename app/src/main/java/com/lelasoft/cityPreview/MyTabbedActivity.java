...
import com.lelasoft.cityPreview.adapter.CitiesAdapter;
...
public class MyTabbedActivity extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View itemView = inflater.inflate(R.layout.fragment_city_tabbed, container, false);
            RecyclerView recyclerView = itemView.findViewById(R.id.recycler_view);
            recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
            List<City> data = Utils.getDatabase();
